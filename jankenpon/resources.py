...
MENU_OPTIONS_PROMPT = (
    'Please, choose "1", "2" or "3" (or "q" to quit) ' + 'and press "Enter"'
)

MENU_OPTIONS = ["1", "2", "3", "quit", "exit"]

SORRY_YES_NO = (
    "Sorry? \x1b[33m" + "Y" + "\x1b[0m" + "es or " + "\x1b[33m" + "N" + "\x1b[0m" + "o"
)
...
HOW_TO_PLAY = (
    "                    " + "==HOW TO PLAY==\n"
    "One player choses paper, scissors or rock; " + "the other player, too.\n\n"
    "Paper beats rock,\n"
    "scissors beat paper\n,"
    "and rock beats scissors.\n\n"
    'If both choices are of the same kind (eg. "rock vs. rock"),' + " it is a tie.\n\n"
